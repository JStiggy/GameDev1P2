...
function create()
{
    ...
    //logo
    logos = BookWyrm.game.add.sprite(BookWyrm.game.camera.width/2, 200, 'logo');
    logos.anchor.set(.5);
    ...
    buttonGroup.add(new GameButton(BookWyrm.game, BookWyrm.game.camera.width/2, BookWyrm.game.camera.height/2+300, 'start' , 
        function () {
